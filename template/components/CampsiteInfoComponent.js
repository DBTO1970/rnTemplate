...
function RenderCampsite(props) {
    ...
    const panResponder = PanResponder.create({
        ...
        onPanResponderGrant: () => {
            ...
            // used pulse animation instead of rubberBand
                    ...
                    image={{uri: baseUrl + campsite.image}} >
                        ...
                        <View style={styles.cardRow} >
                            ...
                            <Icon 
                                ...
                                onPress={
                                    () => shareCampsite(
                                    campsite.name, campsite.description, baseUrl + campsite.image)
                                    }
                            />
                        </View>
                </Card>
                ...
                <Modal 
                    ...
                    <View style={styles.modal}>
                        <Rating 
                            ...
                            imageSize={40} 
                            onFinishRating={
                                rating => this.setState({rating: rating}
                                )
                            } 
                        ...
                        <Input 
                            ...
                            onChangeText={
                                author => this.setState({author: author}
                                )
                                }
                            value= {this.text}
                         />
